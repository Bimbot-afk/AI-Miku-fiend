...
def create_idle_message(main_window):
    ...
    prompt = "[SISTEMA]: El usuario no te ha hablado en un buen rato. Inicia tú la conversación. Escribe un mensaje natural y corto como si le estuvieras hablando por chat, usa esta information, se lo mas personal posible: "
